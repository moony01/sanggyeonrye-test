...
const SUPABASE_KEY =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVldmNrdmRpY2ZocXh5d2l4em50Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjY4NjQwMjQsImV4cCI6MjA4MjQ0MDAyNH0.idh6w8dJ-8Rjdh9aB3DuaYofnO78fNBPuSOG8QoqKqM";
...
function getSupabase() {
  ...
  if (window.supabase) {
    ...
    console.warn(
      "⚠️ window.supabase를 찾을 수 없습니다. CDN 스크립트를 확인하세요.",
    );
  }
...
const MESSAGES = {
  ...
  pl: {
    vote_success: "Zagłosowano na {agency}!",
    vote_duplicate: "Już głosowałeś!",
    comment_empty: "Wpisz treść.",
    nickname_empty: "Wpisz nick.",
    content_empty: "Wpisz komentarz.",
    comment_too_long: "Maks 500 znaków.",
    password_prompt: "Hasło:",
    edit_prompt: "Nowa treść:",
    password_empty: "Podaj hasło.",
    password_wrong: "Złe hasło.",
    delete_success: "Usunięto.",
    update_success: "Zaktualizowano.",
    post_success: "Opublikowano!",
    fail: "Błąd.",
    vote_limit: "Głosowałeś już 3 razy dzisiaj! Wróć jutro.",
    vote_remain: "Zagłosowano! (Pozostało {count})",
  },
  nl: {
    vote_success: "Gestemd op {agency}!",
    vote_duplicate: "Al gestemd!",
    comment_empty: "Inhoud invullen.",
    nickname_empty: "Naam invullen.",
    content_empty: "Reactie invullen.",
    comment_too_long: "Max 500 tekens.",
    password_prompt: "Wachtwoord:",
    edit_prompt: "Nieuwe inhoud:",
    password_empty: "Wachtwoord invullen.",
    password_wrong: "Fout wachtwoord.",
    delete_success: "Verwijderd.",
    update_success: "Aangepast.",
    post_success: "Geplaatst!",
    fail: "Fout.",
    vote_limit: "Je hebt vandaag al 3 keer gestemd! Kom morgen terug.",
    vote_remain: "Gestemd! (Nog {count} vandaag)",
  },
  pt: {
    vote_success: "Votou na {agency}!",
    vote_duplicate: "Já votou!",
    comment_empty: "Insira conteúdo.",
    nickname_empty: "Insira apelido.",
    content_empty: "Insira comentário.",
    comment_too_long: "Máx 500 caracteres.",
    password_prompt: "Senha:",
    edit_prompt: "Novo conteúdo:",
    password_empty: "Insira a senha.",
    password_wrong: "Senha incorreta.",
    delete_success: "Removido.",
    update_success: "Atualizado.",
    post_success: "Publicado!",
    fail: "Erro.",
    vote_limit: "Você já votou 3 vezes hoje! Volte amanhã.",
    vote_remain: "Votado! (Restam {count} votos hoje)",
  },
  ru: {
    vote_success: "Голос за {agency}!",
    vote_duplicate: "Уже голосовали!",
    comment_empty: "Введите текст.",
    nickname_empty: "Введите ник.",
    content_empty: "Введите комментарий.",
    comment_too_long: "Макс 500.",
    password_prompt: "Пароль:",
    edit_prompt: "Новый текст:",
    password_empty: "Введите пароль.",
    password_wrong: "Неверный пароль.",
    delete_success: "Удалено.",
    update_success: "Обновлено.",
    post_success: "Опубликовано!",
    fail: "Ошибка.",
    vote_limit: "Вы уже проголосовали 3 раза сегодня! Приходите завтра.",
    vote_remain: "Проголосовано! (Осталось {count})",
  },
  tr: {
    vote_success: "{agency} oylandı!",
    vote_duplicate: "Zaten oy verdiniz!",
    comment_empty: "İçerik girin.",
    nickname_empty: "Takma ad girin.",
    content_empty: "Yorum girin.",
    comment_too_long: "Maks 500.",
    password_prompt: "Şifre:",
    edit_prompt: "Yeni içerik:",
    password_empty: "Şifre girin.",
    password_wrong: "Yanlış şifre.",
    delete_success: "Silindi.",
    update_success: "Güncellendi.",
    post_success: "Yayınlandı!",
    fail: "Hata.",
    vote_limit: "Bugün zaten 3 kez oy verdiniz! Yarın tekrar gelin.",
    vote_remain: "Oy verildi! (Bugün kalan {count})",
  },
  uk: {
    vote_success: "Голос за {agency}!",
    vote_duplicate: "Вже голосували!",
    comment_empty: "Введіть текст.",
    nickname_empty: "Введіть нік.",
    content_empty: "Введіть коментар.",
    comment_too_long: "Макс 500.",
    password_prompt: "Пароль:",
    edit_prompt: "Новий текст:",
    password_empty: "Введіть пароль.",
    password_wrong: "Невірний пароль.",
    delete_success: "Видалено.",
    update_success: "Оновлено.",
    post_success: "Опубліковано!",
    fail: "Помилка.",
    vote_limit: "Ви вже проголосували 3 рази сьогодні! Приходьте завтра.",
    vote_remain: "Проголосовано! (Залишилось {count})",
  },
};
...
// ============================================================================
// 투표 기능 제거됨 (2025.01.28)
// - fetchVoteCounts(), updateVoteUI(), handleReaction() 함수 삭제
...
async function fetchComments(page = 1) {
  ...
  /*
    const DUMMY_DATA = [
        { id: 101, nickname: '프리패스짱', content: '제 얼굴이 프리패스상이라니 너무 기뻐요! ㅋㅋㅋ 완전 신기방기', created_at: new Date().toISOString(), face_type: 'FREEPASS' },
        { id: 102, nickname: '문전박대ㅠ', content: '문전박대상이래요... 장인어른이 걱정됩니다 ㅠㅠ', created_at: new Date(Date.now() - 86400000).toISOString(), face_type: 'MOONJEON' },
    ];
...
/**
 * [Async] 댓글 삭제
 * - 사용자에게 비밀번호 입력 요구 -> RPC 'delete_sgt_comment' 호출
 */
...
/**
 * [Async] 댓글 수정
 * - 비밀번호 및 새 내용 입력 요구 -> RPC 'update_sgt_comment' 호출
 */
